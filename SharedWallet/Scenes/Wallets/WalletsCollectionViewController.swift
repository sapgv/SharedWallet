...
class WalletsCollectionViewController: UICollectionViewController {
    ...
    private func setupNavigationButton() {
        ...
        let rightButton = UIBarButtonItem(barButtonSystemItem: .add, target: self, action: #selector(addWallet))
